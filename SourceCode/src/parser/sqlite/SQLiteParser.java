...
public class SQLiteSyntaxParser extends Parser {
	...
	public static final int
		...
		RESTRICT=123, RIGHT=124, ROLLBACK=125, ROW=126, SAVEPOINT=127, SELECT=128, 
		SET=129, TABLE=130, TEMP=131, TEMPORARY=132, THEN=133, TO=134, TRANSACTION=135, 
		TRIGGER=136, UNION=137, UNIQUE=138, UPDATE=139, USING=140, VACUUM=141, 
		VALUES=142, VIEW=143, VIRTUAL=144, WHEN=145, WHERE=146, WITH=147, WITHOUT=148, 
